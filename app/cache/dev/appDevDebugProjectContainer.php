...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'accueil', 'user' => 'root', 'password' => 'julien', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array('bit' => 'boolean'));
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'/src/PilotParc/LoginBundle/Resources/config/doctrine') => 'PilotParc\\LoginBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'PilotParc\\LoginBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('PilotParcLoginBundle' => 'PilotParc\\LoginBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7f8786b5317a5f6a51482bca019ff02dde65afb35d442306043b8625ac937a2b');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/PilotParc/LoginBundle/Resources/views'), 'PilotParcLogin');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('236027a2988cc648c53b8730cebfcbaf54392dfe');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58ac2836c02186.93939295')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PilotParcLoginBundle' => 'PilotParc\\LoginBundle\\PilotParcLoginBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'PilotParcLoginBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/PilotParc/LoginBundle'),
                    'namespace' => 'PilotParc\\LoginBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
            ...
            'database_port' => NULL,
            'database_name' => 'accueil',
            'database_user' => 'root',
            'database_password' => 'julien',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '236027a2988cc648c53b8730cebfcbaf54392dfe',
            'locale' => 'en',
            ...
            'kernel.secret' => '236027a2988cc648c53b8730cebfcbaf54392dfe',
